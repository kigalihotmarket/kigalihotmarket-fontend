      ...
      <div className='flex flex-col w-full max-w-full justify-center'>
        <div className='flex w-full justify-center gap-5'>
          <div className='flex flex-1 flex-col justify-center'>
            {isModalOpen ? (
              <div className='relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left  transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6'>
                <div>
                  <div className='mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-primary'>
                    <CheckIcon className='h-6 w-6 text-white' aria-hidden='true' />
                  </div>
                  <div className='mt-3 text-center sm:mt-5'>
                    <h3 className='text-lg my-6 font-medium leading-6 text-gray-900'>
                ...
                <div className='mt-5 sm:mt-6'>
                  <button
                    type='button'
                    className='inline-flex w-full justify-center rounded-md border border-transparent hover:bg-primary bg-primary px-4 py-2 text-base font-medium text-white shadow-sm  focus:outline-none focus:ring-2 focus:ring-lime-700 focus:ring-offset-2 sm:text-sm'
                    onClick={() => {
                      navigate("/auth/login");
                    }}
                  >
                    ...
                    >
                      ...
                      <div className='w-full'>
                        <Button
                          ...
                          className='hover:bg-primary  focus:ring-primary bg-primary w-full rounded-lg'
                        />
                      </div>
                    </form>
                  </div>
